...
insert into tb_produto (frutas, quantidade, preco, categoria_id) values ("pera", 30, 4.00, 1);
insert into tb_produto (legumes, quantidade, preco, categoria_id) values ("cenoura", 80, 6.00, 2);
insert into tb_produto (legumes, quantidade, preco, categoria_id) values ("batata", 100, 4.50, 2);
