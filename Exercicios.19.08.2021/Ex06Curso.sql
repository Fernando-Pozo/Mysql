...
insert into tb_curso (curso, preco, categoria_id) values ("Java", 50.00, 1);
insert into tb_curso (curso, preco, categoria_id) values ("C#", 35.00, 1);
insert into tb_curso (curso, preco, categoria_id) values ("JavaScript", 27.00, 1);
insert into tb_curso (curso, preco, categoria_id) values ("Ruby", 150.00, 1);
